...
/*         e.preventDefault();
    ...
    return (
        ...
        lg:px-24 xl:px-32 text-white mt-[-30px] md:mt-104 relative z-50'>

            <form onSubmit={onSearch} className='bg-white text-gray-500 rounded-lg px-6 
            py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
